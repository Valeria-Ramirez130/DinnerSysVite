...
//PETICIONES GET
routerProductos.get('/getProductos', getProductos); //Traer todos los productos
...
//PETICIONES DELETE
routerProductos.delete('/deleteProducto/:ProductoId', deleteProducto); //Para eliminar un producto
