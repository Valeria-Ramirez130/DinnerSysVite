...
import { createMesa, deleteMesa, getMesas, liberarMesaYFinPedido } from "../controller/Mesas.js";
...
//PETICIONES PUT
routerMesas.put('/liberarMesa/:MesaId/:PedidoId', liberarMesaYFinPedido); //Para cambiar el estado de mesa a 0, es decir, libre
//PETICIONES DELETE
